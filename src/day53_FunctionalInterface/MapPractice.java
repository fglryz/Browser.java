...
public class MapPractice {
    public static void main(String[] args) {
        ...
        for (Map<String, Double> eacUnit : allUnits) {
            for (Map.Entry<String, Double> entry : eacUnit.entrySet()) {
        ...
        System.out.println("======================================");
        // 4. Which Java Topic has the maximum hours? // 5. Which topic has the minimum hours?
